    ...
    if (!err) {
      ...
      collection.find({}).toArray(function(err, items) {
        if (!err) {
          ...
          res.render('user/lunch-menu', {items: resultArray, booking: req.session.booking, orders : req.session.orders}); //Render the page and pass the results in the array as variable item
        }
      });
